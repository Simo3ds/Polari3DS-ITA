...
static void menuDraw(Menu *menu, u32 selected)
{
    ...
    if(isRelease)
        Draw_DrawFormattedString(10, SCREEN_BOT_HEIGHT - 20, COLOR_TITLE, "CustomLuma3DS-ITA %s", versionString);
    else
        Draw_DrawFormattedString(10, SCREEN_BOT_HEIGHT - 20, COLOR_TITLE, "CustomLuma3DS-ITA %s-%08lx", versionString, commitHash);
